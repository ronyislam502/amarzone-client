    ...
    <header className="sticky top-0 z-50 shadow-md font-sans select-none">
      ...
      <div className="bg-[#0071dc] text-white px-3 sm:px-6 py-2.5 flex items-center justify-between gap-3">
        ...
        <Link href="/" className="flex items-center gap-1.5 shrink-0 group">
          <div className="flex items-center gap-1">
            ...
            <WalmartSpark className="w-6 h-6 text-[#ffc220] hover-spark-spin transition-transform duration-300" />
          </div>
        </Link>
        ...
        <div className="relative hidden xl:block" ref={servicesRef}>
          ...
          {/* Services Popover */}
          {isServicesOpen && (
            <div className="absolute top-full left-0 mt-2 w-80 bg-white text-slate-800 rounded-2xl shadow-2xl border border-slate-100 py-3 z-50 animate-in fade-in zoom-in-95 duration-150">
              <div className="px-4 py-2 text-xs font-black uppercase tracking-wider text-slate-400 border-b border-slate-100">
                Amarzone Services
              </div>
              <div className="py-1">
                {servicesList.map((svc, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <div className="text-xs sm:text-sm font-bold text-slate-900">{svc.name}</div>
      ...
      <div className="bg-[#004f9a] text-white border-t border-blue-500/30 px-3 sm:px-6 py-1.5 flex items-center justify-between text-xs overflow-x-auto no-scrollbar">
        ...
        <div className="relative shrink-0" ref={fulfillmentRef}>
          ...
          {isFulfillmentOpen && (
            <div className="absolute top-full left-0 mt-2 w-80 bg-white text-slate-900 rounded-2xl shadow-2xl border border-slate-100 p-4 z-50 animate-in fade-in duration-150">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-3">
                <span className="font-extrabold text-sm text-slate-900">Shipping & Store Options</span>
              ...
              {/* Toggle Types */}
              <div className="grid grid-cols-3 gap-1.5 p-1 bg-slate-100 rounded-xl text-xs font-bold mb-4">
                <button
                  type="button"
        ...
        <div className="flex items-center gap-4 text-xs font-semibold whitespace-nowrap text-blue-100 ml-4">
          ...
          <Link href="/?search=Electronics" className="hover:underline hover:text-white transition-colors">
            Electronics
          </Link>
