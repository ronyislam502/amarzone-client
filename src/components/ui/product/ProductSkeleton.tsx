...
export const ProductSkeleton: React.FC = () => {
  return (
    <div className="bg-base-100 min-h-screen py-6 px-4 md:px-8 max-w-[1500px] mx-auto animate-pulse">
      {/* Breadcrumb Skeleton */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-3">
          <div className="border border-base-300 rounded-xl p-5 space-y-4 shadow-sm bg-base-200">
