...
const AuthBrandShowcase = () => {
    return (
        <div className="relative hidden lg:flex flex-col justify-between p-8 lg:p-12 overflow-hidden bg-slate-900/80 border-r border-white/10 text-slate-100 rounded-none lg:w-1/2">
            ...
            <div className="relative z-10">
                ...
                <h1 className="text-4xl font-extrabold tracking-tight leading-tight mb-4">
                    Elevate Your <br />
                    <span className="text-transparent bg-clip-text from-warning via-amber-200 to-orange-400">
                        Shopping Experience
                    </span>
                </h1>
