  ...
  return (
    <div className="space-y-6 w-full pb-10 animate-pulse">
      ...
      <div className="card relative overflow-hidden bg-[#170d2f] shadow-2xl border border-white/10 rounded-2xl sm:rounded-3xl">
        <div className="h-36 sm:h-48 w-full bg-white/5" />
        <div className="p-6 sm:p-8 space-y-4">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
            <div className="w-24 h-24 rounded-2xl bg-white/10 border border-white/10 -mt-16 sm:-mt-20 shrink-0" />
            <div className="space-y-3 flex-1 w-full text-center sm:text-left">
              <div className="h-6 w-52 bg-white/10 rounded-lg mx-auto sm:mx-0" />
